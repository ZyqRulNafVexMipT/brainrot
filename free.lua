...
WindUI:Popup({
    Title = "VortXHub Loaded | 99 Nights in the Forest",
    Icon = "star",
    IconThemed = true,
    Content = "VortXHub Is FUCKING op | Join our discord",
    Buttons = {
...
local Window = WindUI:CreateWindow({
    ...
    Title = "VortXHub | V1 | 99 Nights In The Forest | Beta",
    IconThemed = true,
    Icon = "star",
...
Window:EditOpenButton({
    Title = "VortXHub | 99 Nights In The Forest",
    Icon = "monitor",
